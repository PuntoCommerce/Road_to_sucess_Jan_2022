      ...
      "object" == typeof r &&
        ...
        Object.keys(r.fields).forEach(function (t) {
          if (r.fields[t]) {
            ...
            n.length > 0 &&
              (Array.isArray(r[t])
                ? n.html(r.fields[t].join("<br/>"))
                : n.html(r.fields[t]),
              n.siblings(".form-control").addClass("is-invalid"));
          }
        }),
      r && r.error) &&
        ("FORM" === $(e).prop("tagName") ? $(e) : $(e).parents("form")).prepend(
              ...
              success: function (e) {
                r.spinner().stop(),
                  e.success
                    ...
                    : (n(r, e), $("form.login").trigger("login:error", e));
              },
              error: function (e) {
          ...
          return (
            ...
            $.ajax({
              ...
              error: function (e) {
                e.responseJSON.redirectUrl
                  ? (window.location.href = e.responseJSON.redirectUrl)
                  : o($(".error-messaging"), e.responseJSON.errorMessage),
                  r.spinner().stop();
              },
            }),
            !1
          ...
          return (
            ...
            $.ajax({
              ...
              success: function (e) {
                r.spinner().stop(),
                  e.success
                    ? ($(".request-password-title").text(e.receivedMsgHeading),
