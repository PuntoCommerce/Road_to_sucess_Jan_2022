     ...
     */ !(function (t, n) {
        ...
        special: {
          ...
          click: {
            ...
            trigger: function (e) {
              var t = this || e;
              return (
                me.test(t.type) && t.click && D(t, "input") && Ee(t, "click"),
                !0
              );
            },
            _default: function (e) {
      ...
      function Me(e, t, n, o) {
        ...
        var r,
          ...
          h = t[0],
          m = g(h);
        if (m || (f > 1 && "string" == typeof h && !v.checkClone && Oe.test(h)))
        ...
        if (
          ...
          for (s = (a = _.map(be(r, "script"), Ne)).length; d < f; d++)
            (c = r),
              d !== p &&
          ...
          if (s)
            for (
              u = a[a.length - 1].ownerDocument, _.map(a, Ie), d = 0;
              d < s;
              d++
            )
              (c = a[d]),
                ge.test(c.type || "") &&
                  ...
                  (c.src && "module" !== (c.type || "").toLowerCase()
                    ...
                    : w(c.textContent.replace(Ae, ""), c, u));
        }
        return e;
      }
      function Le(e, t, n) {
          ...
          stop: function (e, t, n) {
            ...
            return (
              ...
              this.each(function () {
                ...
                else for (r in a) a[r] && a[r].stop && at.test(r) && o(a[r]);
                for (r = i.length; r--; )
                  i[r].elem !== this ||
                    (null != e && i[r].queue !== e) ||
      ...
      _.extend(_.event, {
        trigger: function (e, t, o, r) {
          ...
          if (
            ...
            if (!r && !d.noBubble && !y(o)) {
              for (
                l = d.delegateType || m, $t.test(l + m) || (a = a.parentNode);
                a;
                a = a.parentNode
              )
                h.push(a), (s = a);
      ...
      _.ajaxSetup({
        ...
        _.each(["top", "left"], function (e, t) {
          _.cssHooks[t] = We(v.pixelPosition, function (e, n) {
            if (n)
              return (n = Fe(e, t)), He.test(n) ? _(e).position()[t] + "px" : n;
          });
        }),
      ...
      return (
        (_.noConflict = function (e) {
          return (
            n.$ === _ && (n.$ = Kt), e && n.jQuery === _ && (n.jQuery = Jt), _
          );
        }),
        ...
        e.totals.orderLevelDiscountTotal.value > 0
          ? ($(".order-discount").removeClass("hide-order-discount"),
            $(".order-discount-total")
              .empty()
              .append("- " + e.totals.orderLevelDiscountTotal.formatted))
          : $(".order-discount").addClass("hide-order-discount"),
        e.totals.shippingLevelDiscountTotal.value > 0
          ? ($(".shipping-discount").removeClass("hide-shipping-discount"),
            $(".shipping-discount-total")
              .empty()
              .append("- " + e.totals.shippingLevelDiscountTotal.formatted))
